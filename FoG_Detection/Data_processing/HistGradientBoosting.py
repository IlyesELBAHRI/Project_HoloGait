...
hgb_classifier = HistGradientBoostingClassifier(class_weight='balanced', max_leaf_nodes=len(all_features), random_state=42)
...
# Save the model
joblib.dump(hgb_classifier, 'hgb_classifier.pkl')
